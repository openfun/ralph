...
class VideoInitializedContextExtensions(VideoContextExtensions):
    ...
    ccSubtitleEnabled: Annotated[
        Optional[bool], Field(None, alias=CONTEXT_EXTENSION_CC_ENABLED)
    ]
    ccSubtitleLang: Annotated[
        Optional[str], Field(None, alias=CONTEXT_EXTENSION_CC_SUBTITLE_LANG)
    ]
    fullScreen: Annotated[
        Optional[bool], Field(None, alias=CONTEXT_EXTENSION_FULL_SCREEN)
    ]
    screenSize: Annotated[
        Optional[str], Field(None, alias=CONTEXT_EXTENSION_SCREEN_SIZE)
    ]
    videoPlaybackSize: Annotated[
        Optional[str], Field(None, alias=CONTEXT_EXTENSION_VIDEO_PLAYBACK_SIZE)
    ]
    speed: Annotated[Optional[str], Field(None, alias=CONTEXT_EXTENSION_SPEED)]
    userAgent: Annotated[Optional[str], Field(None, alias=CONTEXT_EXTENSION_USER_AGENT)]
    volume: Annotated[Optional[int], Field(None, alias=CONTEXT_EXTENSION_VOLUME)]
    completionThreshold: Annotated[
        Optional[float], Field(None, alias=CONTEXT_EXTENSION_COMPLETION_THRESHOLD)
    ]
