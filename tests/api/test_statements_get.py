...
def test_api_statements_get_statements_scopes(monkeypatch, fs, es, auth_method, user_scopes, is_authorized):
    ...
    if auth_method == "basic":
        ...
        credentials = create_user(fs, username, password, scopes, agent)
