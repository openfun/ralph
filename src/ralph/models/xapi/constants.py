...
# xAPI activities.
XAPI_ACTIVITY_PAGE = Literal["http://activitystrea.ms/schema/1.0/page"]

# xAPI verbs.
XAPI_VERB_TERMINATED = Literal["http://adlnet.gov/expapi/verbs/terminated"]
XAPI_VERB_VIEWED = Literal["http://id.tincanapi.com/verb/viewed"]
...
# Display Names.
TERMINATED = Literal["terminated"]
VIEWED = Literal["viewed"]
PAGE = Literal["page"]
