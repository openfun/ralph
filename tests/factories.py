...
from ralph.models.xapi import VirtualClassroomAnsweredPoll

from ralph.models.xapi.concepts.activity_types.virtual_classroom import VirtualClassroomActivity
...
def prune(d: Any, exceptions: list = []):
    ...
    if isinstance(d, dict):
        ...
        d_dict_exceptions = {
            k: v for k, v in d.items() if k in exceptions
        }
