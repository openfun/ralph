...
class NotesEventField(AbstractBaseEventField):
    ...
    Attributes:
        component_usage_id (int): Consists of the unique identifier for the text
        ...
        note_text (int): Consists of the text of the note.
    ...
    tags: List[str] = []
    truncated: List[Literal["note_text", "highlighted_content", "tags"]] = []
...
class UIEdxCourseStudentNotesEditedEventField(NotesEventField):
    ...
    Attributes:
        old_note_text (int): Consists of the text of the note before the learner
            edited it.
