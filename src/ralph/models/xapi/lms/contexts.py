...
class LMSRegistrationContextExtensions(BaseExtensionModelWithConfig):
    ...
    starting_date: Annotated[
        Optional[datetime], Field(None, alias=CONTEXT_EXTENSION_STARTING_DATE)
    ]
    ending_date: Annotated[
        Optional[datetime], Field(None, alias=CONTEXT_EXTENSION_ENDING_DATE)
    ]
...
class LMSCommonContextExtensions(BaseExtensionModelWithConfig):
    ...
    session_id: Annotated[
        Optional[UUID], Field(None, alias=CONTEXT_EXTENSION_SESSION_ID)
    ]
...
class LMSDownloadedVideoContextExtensions(LMSCommonContextExtensions):
    ...
    length: Annotated[
        ...
        Field(None, alias=CONTEXT_EXTENSION_LENGTH),
    ]
    quality: Annotated[Optional[PositiveInt], Field(alias=CONTEXT_EXTENSION_QUALITY)]
...
class LMSDownloadedAudioContextExtensions(LMSCommonContextExtensions):
    ...
    length: Annotated[
        Optional[NonNegativeFloat], Field(None, alias=CONTEXT_EXTENSION_LENGTH)
    ]
