...
"""
from ralph.schemas.edx.ora.student_training_assess_example import StudentTrainingAssessExampleSchema
...
def test_loading_valid_events_should_not_raise_exceptions():
    ...
    check_loading_valid_events(StudentTrainingAssessExampleSchema(), "student_training_assess_example")