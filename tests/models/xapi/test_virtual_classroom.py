...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            r"Input should be 'https://w3id.org/xapi/virtual-classroom'",
        ),
        (
            {
                "id": "https://w3id.org/xapi/virtual-classroom",
        ...
        (
            [{"id": "https://w3id.org/xapi/not-virtual-classroom"}],
            (
                "The `context.contextActivities.category` field should contain "
                "at least one valid `VirtualClassroomProfileActivity`"
            ),
        ),
        (
            [
